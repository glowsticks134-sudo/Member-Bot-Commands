    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          "`/tos` — Post Terms of Service",
          "`/info` — About Memberk",
          "`/howto` — How to use guide",
          "`/payment_methods` — Accepted payment methods",
          "`/invite_rewards` — Invite reward tiers",
        ].join("\n"),
        inline: false,
      },
      {
        ...
        value: [
          ...
          "`/role_plans` — Set pricing & post role plans embed",
          "`/private_bot` — Set pricing & post private bot listing",
          "`/free_bronze_role invite_link: role:` — Post free bronze embed & configure status watcher",
          "`/status_role_set invite_link: role:` — Configure status role watcher",
          "`/status_role_status` — Show current status role config",
          "`/status_role_clear` — Remove status role config",
          "`/bronze_log_set channel:` — Set bronze log channel",
          "`/set_log_channel channel:` — Set bot activity log channel",
          "`/clear_log_channel` — Remove bot log channel",
        ].join("\n"),
        inline: false,
      },
      {
